            ...
            >
                ...
                >
                    <Button
                        ...
                        className={cn(
                                  "w-full hover:ring-transparent hover:ring-offset-0 flex-col h-auto py-1.5 px-3.5 capitalize font-semibold ring-offset-sidebar",
                                  {
            ...
            <CollapsibleTrigger
                ...
                <div className='peer flex items-center group [&[data-state=open]>button>div>div>svg]:rotate-180' >
                    <Button
                        ...
                        variant={active ? "default" : "ghost"}
                        color='secondary'
                        className={cn('justify-start capitalize group h-auto py-3 md:px-3 px-3 ring-offset-sidebar group-data-[state=open]:bg-secondary hover:ring-transparent w-full', {
                    ...
                    subChildren?.length === 0 ? (
                        ...
                        <React.Fragment key={index}>
                            <MultiCollapseMenuButton
                                label={label}
                                active={active}
                                submenus={subChildren as Submenu[]}
            ...
            <TooltipProvider disableHoverableContent>
                <Tooltip delayDuration={100}>
                    ...
                    {/* <TooltipContent side="right" align="start" alignOffset={2}>
                        {({ contentProps }: { contentProps: React.HTMLAttributes<HTMLSpanElement> }) => (
                            <span {...contentProps}>{label}</span>
                        )}
                    </TooltipContent> */}
                </Tooltip>
            </TooltipProvider>

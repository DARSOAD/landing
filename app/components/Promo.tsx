...
export default function Promo() {
    return (
        ...
        >
            ...
            {/* Beneficios */}
            <div className="mt-[90vh] pb-8 px-4 w-full transform grid grid-cols-3 gap-6 text-[#5c87a3] font-light text-xs lg:grid-cols-4 md:text-lg md:mt-[calc(120vh)] 2xl:mt-[800px] 2xl:px-36 2xl:text-2xl 2xl:pb-20">

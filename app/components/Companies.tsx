...
const Companies = ({ data, title }: CompaniesProps) => {
        return (
        ...
        "
                >
                        <h4 className="text-gray-800 font-sans text-center w-full text-sm pt-8 px-8 lg:text-2xl leading-none 2xl:pt-4">{title}</h4>
